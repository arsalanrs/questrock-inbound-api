...
• borrower_loan_details object (extract from transcript — use "" if not stated):
  ...
  - **payment_breakdown nested object** (use "" if caller did not know or did not have statement handy):
    monthly_payment_total, principal_and_interest, property_taxes, homeowners_insurance, hoa, pmi, notes
    notes — e.g. "Only total P&I stated; taxes/insurance unknown"
